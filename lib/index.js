...
class Router {
    ...
    serveFileRelative(file, alias, cacheDuration = 10000) {
        this.serveFile(path_1.default.resolve(__dirname, file), alias, cacheDuration);
    }
    /**
     ...
     */
    endpoint(method, handler, alias = undefined, _this = undefined) {
        ...
        this.app[method](path, (res, req) => {
            ...
            res.onData(async (data, isLast) => {
                ...
                if (isLast) {
                    currentHandler(new RequestData(headers, this.getHttpMethod(method), body.toString(), query, res));
                }
            });
        });
    }
